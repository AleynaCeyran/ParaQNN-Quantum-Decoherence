...
class QuantumTrainer:
    ...
    def __init__(self, config_path: Path):
        ...
        set_reproducibility(seed, self.device)
    ...
    def execute(self) -> None:
        ...
        save_dir_rel = Path(ckpt_cfg.get("save_dir", "checkpoints"))
        save_dir = save_dir_rel if save_dir_rel.is_absolute() else (self.project_root / save_dir_rel)
...
def main() -> int:
    ...
    trainer = QuantumTrainer(cfg_path)
